...
public class Medoids_A_Mapper extends Mapper<Object, Text, IntWritable, Text> {
    ...
    protected void setup(Context context) throws IOException, InterruptedException {
        ...
        Path medoidsPath = new Path("/project2/Input_Files/Kmedseed.csv");

        FileSystem fs = FileSystem.get(conf);
        BufferedReader br = new BufferedReader(new InputStreamReader(fs.open(medoidsPath)));

        String line;
        medoids = new ArrayList<>();

        // Read medoids from Kmedseed.csv
