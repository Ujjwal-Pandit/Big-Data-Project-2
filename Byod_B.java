...
public class Byod_B {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length != 3) {
            System.err.println("Usage: Byod_B <input path> <output path> <number of iterations>");
            System.exit(-1);
        }
        ...
        for (int i = 0; i < numIterations; i++) {
            ...
            job.setJarByClass(Byod_B.class);
            job.setMapperClass(Byod_B_Mapper.class);
            job.setReducerClass(Byod_B_Reducer.class);
