...
public class Byod_E {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length != 4) {
            System.err.println("Usage: Byod_E <input path> <output path> <max iterations> <convergence threshold>");
            System.exit(-1);
        }
        ...
        String initialCentroidsPath = "/project2/Input_Files/College_Kseed3.csv";
        ...
        for (iteration = 0; iteration < maxIterations && !converged; iteration++) {
            ...
            job.setJarByClass(Byod_E.class);
            job.setMapperClass(Byod_E_Mapper.class);
            job.setCombinerClass(Byod_E_Combiner.class);
            job.setReducerClass(Byod_E_Reducer.class);
